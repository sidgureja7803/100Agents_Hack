        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="agents" className="space-y-8">
            <div className="space-y-6">
              <div>
                <h2 className="text-3xl font-bold text-slate-900 mb-2">🤖 AI Agent DevOps System</h2>
                <p className="text-slate-600">
                  Advanced multi-agent system that clones, analyzes, and generates CI/CD configurations automatically
                </p>
              </div>
              ...
              <AgentGenerationForm
                onComplete={(result) => {
                  setApiResponse({
                    dockerfile: result.techStack?.dockerfile || 'Generated Dockerfile',
                    githubActions: result.techStack?.githubActions || 'Generated GitHub Actions',
                    envExample: result.techStack?.envExample || 'Generated .env.example',
                    docs: 'Generated by AI Agents'
                  });
                  setShowOutput(true);
                  setShowChat(true);
                  ...
                  const newProject: Project = {
                    ...
                    techStack: result.techStack?.primary || 'Detected Stack',
                    status: 'completed',
                    createdAt: new Date().toISOString().split('T')[0],
                    lastGenerated: new Date().toISOString().split('T')[0],
                    deploymentCount: 1
